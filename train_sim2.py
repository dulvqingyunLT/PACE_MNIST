...
class Model(torch.nn.Module):
    def __init__(self):
        ...
        self.conv3 = torch.nn.Conv2d(64, 64, kernel_size=(3, 3), stride=(1, 1), padding=1, bias=False)
        self.conv4 = torch.nn.Conv2d(64, 10, kernel_size=(3, 3), stride=(1, 1), bias=False)         
        # self.fc1 = torch.nn.Linear(3136, 128)
        # self.fc2 = torch.nn.Linear(128, 10)

    def forward(self, x):
        """前向传播"""
        
        x_bin = torch.where(x>0.0, 1.0, 0.0) # 二值化
